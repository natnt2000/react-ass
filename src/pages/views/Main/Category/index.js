...
const ProductInCategory = ({categories, onAddToCart}) => {
    ...
    useEffect(() => {
        getAllProductsInCategory(_id);
    }, [_id])

    const getAllProductsInCategory = async (_id) => {
                        ...
                        <div className="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
                            <div className="d-flex flex-wrap">
                                <div className="form-inline flex-nowrap mr-3 mr-sm-4 pb-3">
                                    ...
                                    {/* <span className="font-size-sm text-light opacity-75 text-nowrap ml-2 d-none d-md-block">of {products.length} products</span> */}
                                </div>
                            </div>
                        </div>
                        {/* Products grid*/}
